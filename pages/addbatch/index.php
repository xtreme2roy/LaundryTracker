						...
						<td colspan=6 align=center>
							<?php 
								...
								if($batchDetails[1] != "current"){																	
									...
									echo "<b>Date:</b> ".$batchDetails[1]." | <b>Time:</b> ".$deliveryTime[0].":".$deliveryTime[1]." ".strtoupper($deliveryTime[2])." | Count: <b>".$laundryCount."</b> | Delivered: ".$isDelivered." | Claimed: ".$isClaimed;
									...
									echo "<b>Date:</b> ".date('Y-m-d')." | <b>Time:</b> ".date('h:i A')." | Count: <b>".$laundryCount."</b> | Delivered: ".$defaultStatus." | Claimed: ".$defaultStatus;
								}
							?>
						</td>
					</tr>
